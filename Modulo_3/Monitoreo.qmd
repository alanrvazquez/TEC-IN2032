...
:::: {style="font-size: 85%;"}
::: incremental
- puede estimar los parámetros de un proceso de producción y determinar la capacidad de un proceso para cumplir con las especificaciones.
...
::: notes
Si es costoso hace mediciones o si el proceso tiene materiales caros, entonces el tamaño del subgrupo es pequeño, 1, por ejemplo. De lo contratrio, puede ser grande. 
:::
