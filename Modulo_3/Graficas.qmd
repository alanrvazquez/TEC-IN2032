...
Recuerda que, para usar las gráficas y los promedios de los subgrupos
deben de seguir una distribución normal. Para evaluar esto, primero calculamos
los promedios por subgrupo usando la función `.groupby()` de **pandas**. 
