...
Una estadística de prueba tiene [una distribución de probabilidad asociada, que depende de la hipótesis asumida]{style="color: darkgreen"} ($H_0$ o $H_1$).
...
Al realizar una prueba de hipótesis, existen dos decisiones posibles: **rechazar** [o]{.underline} **no rechazar** $H_0$.
...
Si $H_0: \mu = \mu_0$ [**no**]{.underline} es verdadera, entonces $t_0 = \frac{\bar{y} - \mu_0}{s/\sqrt{n}}$ deberá estar lejos de 0, el valor con más densidad de la distribución $t$.
...
::: {.column width="50%"}
![](images/pvalor.png){fig-align="center"}
:::
:::::
...
- Pero, [*¿qué tan pequeño?*]{style="color: pink"}

- **Respuesta**: ¡Muy pequeño!

- Pero, dime [*¿qué tan pequeño?*]{style="color: pink"}
...
::: {.column width="50%"}
![](images/clipboard-2242705857.png){fig-align="center"}
