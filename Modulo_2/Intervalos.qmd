...
## ¿Cómo seleccionamos el valor de $\alpha$?
...
Primero, realizamos una prueba de hipótesis (más detalles en la siguiente clase) usando la función `ttest_1samp()` de **scipy.stats**.
...
La variable `Tipo` es [**categorica**]{style="color: red"}! Entonces, debemos de informar a Python sobre esto usando la función `pd.Categorical()`.
