...
[_**Interpretación**_]{style="color: pink"}: Si, en el muestreo aleatorio repetido, construimos muchos intervalos de confianza $[L, U]$, $100(1-\alpha)$% de ellos incluirán el verdadero valor de $\mu$. 
...
Si las dos muestras son independientes, entonces un [intervalo de confianza de nivel $100(1-\alpha)\%$ para $\mu_y - \mu_x$]{style="color: #4682B4"} es 
...
Si las distribuciones tienen la misma varianza, entonces un [intervalo de confianza de nivel $100(1-\alpha)\%$ para $\mu_y - \mu_x$]{style="color: #4682B4"} es
...
Si las distribuciones tienen differentes varianzas, entonces un [intervalo de confianza de nivel $100(1-\alpha)\%$ para $\mu_y - \mu_x$]{style="color: #4682B4"} es
