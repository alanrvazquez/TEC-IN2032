...
La [**varianza teórica**]{style="color: darkgreen;"} de una variable aleatoria $(Y - E(Y))^2$ es el valor esperado de $(Y$, donde $E(Y)$ es el valor esperado de la variable aleatoria. Tecnicamente, la varianza de $Y$ es
